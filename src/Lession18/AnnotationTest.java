...
public class AnnotationTest {
    ...
    @MyProfile
    public static Auto getMaxPriceAutoHashSet(HashSet<Auto> autos) {
        Auto result = null;
    ...
    @MyProfile
    public static Auto getMaxPricefAutobyReflection(Object autos) throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    ...
    @MyProfile
    public static Auto getMaxPriceFromTreeSet(TreeSet<Auto> autos) {
        return autos.last();
    }
